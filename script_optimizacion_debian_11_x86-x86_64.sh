...
# Aplicar optimizaciones específicas para x86/x86_64 si es aplicable
if uname -m | grep -q "x86_64\|i686"; then
    echo "Aplicando optimizaciones específicas para x86/x86_64..."
    # Aquí puedes agregar cualquier configuración o instalación de paquete específica para x86/x86_64
